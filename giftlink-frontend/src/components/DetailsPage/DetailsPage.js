...
import { urlConfig } from '../../config'; // Ensure this is imported to get backendUrl
...
function DetailsPage() {
    ...
    useEffect(() => {
        ...
        const fetchGift = async () => {
            try {
                // Task 2: Fetch gift details using dynamic URL parameter string
    ...
    const handleBackClick = () => {
        // Task 4: Handle back click using navigate(-1)
        navigate(-1);
    };
        ...
        <div className="container mt-5">
            ...
            <div className="card product-details-card">
                ...
                <div className="card-body">
                    ...
                    {/* Task 6: Display gift details using dot notation properties */}
